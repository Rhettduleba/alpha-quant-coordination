...
|----|------|----------|--------|----------|--------------|---------------|-------------|--------------|
| TUNE-01 | Fade-vs-breakout split | selection | candidate | per-name mean-reversion + ownership-mix to choose fade vs breakout; +multi-horizon breakout_R/fade_R logger @15/60m/EOD (LIVE post-close in eod_debrief -> fade_breakout_log.jsonl); +auction-imbalance MR as large-cap/extended-from-VWAP fade evidence; +test SKIP/veto direction (NET avoided-losers minus missed-winners) | data: institutional % | H-FADE-VS-BREAKOUT | fade-breakout | 2026-06-20 |
