...
> **Generated:** 2026-07-30 16:50:43 Eastern Daylight Time · **coordination-repo HEAD:** `270fc0a` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-30T07:30:32.771601-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 578/753 = 76.8% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 315/319 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 263/434 = 61% | `stop_coverage_audit.py` |
| Median placement latency | 257s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 641, 'eod_flatten': 65}) | `stop_coverage_audit.py exit-mechanism tally` |
