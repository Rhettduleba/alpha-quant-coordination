...
> **Generated:** 2026-09-01 16:51:01 Eastern Daylight Time · **coordination-repo HEAD:** `eab4b6c` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-01T07:30:31.428430-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1005/1181 = 85.1% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 518/523 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 487/658 = 74% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1060, 'eod_flatten': 70}) | `stop_coverage_audit.py exit-mechanism tally` |
