...
> **Generated:** 2026-08-13 16:51:03 Eastern Daylight Time · **coordination-repo HEAD:** `4c62297` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-13T07:30:31.947076-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 723/898 = 80.5% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 381/385 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 342/513 = 67% | `stop_coverage_audit.py` |
| Median placement latency | 264s (~4.4 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 49, 'candle/chandelier': 780, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
