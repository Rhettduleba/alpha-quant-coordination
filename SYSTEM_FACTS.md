...
> **Generated:** 2026-07-12 16:50:23 Eastern Daylight Time · **coordination-repo HEAD:** `a73d3d7` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-10T07:30:33.435656-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 320/495 = 64.6% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 184/188 = 98% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 136/307 = 44% | `stop_coverage_audit.py` |
| Median placement latency | 306s (~5.1 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 38, 'candle/chandelier': 394, 'eod_flatten': 63}) | `stop_coverage_audit.py exit-mechanism tally` |
