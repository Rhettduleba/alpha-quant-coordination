...
> **Generated:** 2026-08-26 16:50:57 Eastern Daylight Time · **coordination-repo HEAD:** `3d72003` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-26T07:30:33.769747-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 932/1108 = 84.1% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 482/487 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 450/621 = 72% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 988, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
