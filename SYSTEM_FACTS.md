...
> **Generated:** 2026-08-17 16:50:57 Eastern Daylight Time · **coordination-repo HEAD:** `d794182` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-17T07:30:30.652165-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 776/951 = 81.6% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 406/410 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 370/541 = 68% | `stop_coverage_audit.py` |
| Median placement latency | 263s (~4.4 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 50, 'candle/chandelier': 832, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
