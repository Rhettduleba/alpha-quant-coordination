...
> **Generated:** 2026-09-10 16:51:53 Eastern Daylight Time · **coordination-repo HEAD:** `95366a4` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-10T07:30:32.252298-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1107/1283 = 86.3% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 568/573 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 539/710 = 76% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1162, 'eod_flatten': 70}) | `stop_coverage_audit.py exit-mechanism tally` |
