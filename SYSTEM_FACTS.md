...
> **Generated:** 2026-07-16 16:51:14 Eastern Daylight Time · **coordination-repo HEAD:** `5819202` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-16T07:30:33.426902-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 414/589 = 70.3% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 231/235 = 98% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 183/354 = 52% | `stop_coverage_audit.py` |
| Median placement latency | 298s (~5.0 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 44, 'candle/chandelier': 481, 'eod_flatten': 64}) | `stop_coverage_audit.py exit-mechanism tally` |
