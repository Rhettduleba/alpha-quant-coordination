...
> **Generated:** 2026-07-28 16:50:45 Eastern Daylight Time · **coordination-repo HEAD:** `d578f78` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-28T07:31:09.612870-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 562/737 = 76.3% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 310/314 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 252/423 = 60% | `stop_coverage_audit.py` |
| Median placement latency | 257s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 625, 'eod_flatten': 65}) | `stop_coverage_audit.py exit-mechanism tally` |
