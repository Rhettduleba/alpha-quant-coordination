...
> **Generated:** 2026-07-05 16:50:22 Eastern Daylight Time · **coordination-repo HEAD:** `b3041ef` · by `strategy-research/system_facts.py` (read-only).
...
| Entries with a broker resting stop | 190/365 = 52.1% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 120/124 = 97% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 70/241 = 29% | `stop_coverage_audit.py` |
| Median placement latency | 302s (~5.0 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 32, 'candle/chandelier': 271, 'eod_flatten': 62}) | `stop_coverage_audit.py exit-mechanism tally` |
