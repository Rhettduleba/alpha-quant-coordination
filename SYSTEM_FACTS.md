...
> **Generated:** 2026-08-19 16:50:58 Eastern Daylight Time · **coordination-repo HEAD:** `b43a0f4` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-19T07:30:33.724181-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 821/996 = 82.4% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 425/429 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 396/567 = 70% | `stop_coverage_audit.py` |
| Median placement latency | 260s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 50, 'candle/chandelier': 877, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
