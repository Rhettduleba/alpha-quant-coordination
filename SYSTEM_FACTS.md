...
> **Generated:** 2026-08-15 16:50:49 Eastern Daylight Time · **coordination-repo HEAD:** `d7c36f3` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-14T07:30:33.002132-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 746/921 = 81.0% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 392/396 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 354/525 = 67% | `stop_coverage_audit.py` |
| Median placement latency | 263s (~4.4 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 49, 'candle/chandelier': 803, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
