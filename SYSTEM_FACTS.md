...
> **Generated:** 2026-07-06 16:50:30 Eastern Daylight Time · **coordination-repo HEAD:** `ad0e3a7` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-06T07:30:23.100484-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 217/392 = 55.4% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 135/139 = 97% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 82/253 = 32% | `stop_coverage_audit.py` |
| Median placement latency | 299s (~5.0 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 33, 'candle/chandelier': 297, 'eod_flatten': 62}) | `stop_coverage_audit.py exit-mechanism tally` |
