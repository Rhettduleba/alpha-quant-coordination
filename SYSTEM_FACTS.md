...
> **Generated:** 2026-09-15 16:51:10 Eastern Daylight Time · **coordination-repo HEAD:** `886eec5` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-15T07:30:33.263904-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1138/1315 = 86.5% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 575/580 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 563/735 = 77% | `stop_coverage_audit.py` |
| Median placement latency | 260s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1193, 'eod_flatten': 71}) | `stop_coverage_audit.py exit-mechanism tally` |
