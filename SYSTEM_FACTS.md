...
| Universe generated_at | 2026-07-01T07:30:28.688244-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 170/345 = 49.3% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 120/124 = 97% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 50/221 = 23% | `stop_coverage_audit.py` |
| Median placement latency | 316s (~5.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 32, 'candle/chandelier': 251, 'eod_flatten': 62}) | `stop_coverage_audit.py exit-mechanism tally` |
