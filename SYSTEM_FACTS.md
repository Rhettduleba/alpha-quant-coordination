...
> **Generated:** 2026-07-29 16:50:50 Eastern Daylight Time · **coordination-repo HEAD:** `cbecfec` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-29T07:30:33.407652-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 570/745 = 76.5% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 311/315 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 259/430 = 60% | `stop_coverage_audit.py` |
| Median placement latency | 256s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 633, 'eod_flatten': 65}) | `stop_coverage_audit.py exit-mechanism tally` |
