...
> **Generated:** 2026-07-27 16:50:51 Eastern Daylight Time · **coordination-repo HEAD:** `dd5defe` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-27T07:30:34.650688-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 545/720 = 75.7% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 297/301 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 248/419 = 59% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 608, 'eod_flatten': 65}) | `stop_coverage_audit.py exit-mechanism tally` |
