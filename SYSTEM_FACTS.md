...
> **Generated:** 2026-09-17 16:51:47 Eastern Daylight Time · **coordination-repo HEAD:** `0e98d05` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-17T07:30:33.260518-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1154/1331 = 86.7% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 580/585 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 574/746 = 77% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1209, 'eod_flatten': 71}) | `stop_coverage_audit.py exit-mechanism tally` |
