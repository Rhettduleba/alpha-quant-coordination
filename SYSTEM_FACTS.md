...
> **Generated:** 2026-07-17 16:50:49 Eastern Daylight Time · **coordination-repo HEAD:** `16a5757` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-17T07:30:34.554206-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 430/605 = 71.1% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 239/243 = 98% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 191/362 = 53% | `stop_coverage_audit.py` |
| Median placement latency | 280s (~4.7 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 46, 'candle/chandelier': 495, 'eod_flatten': 64}) | `stop_coverage_audit.py exit-mechanism tally` |
