...
> **Generated:** 2026-09-09 16:50:58 Eastern Daylight Time · **coordination-repo HEAD:** `b91c87a` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-09T07:30:33.071251-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1092/1268 = 86.1% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 566/571 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 526/697 = 75% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1147, 'eod_flatten': 70}) | `stop_coverage_audit.py exit-mechanism tally` |
