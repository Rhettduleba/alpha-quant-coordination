...
> **Generated:** 2026-09-16 16:51:08 Eastern Daylight Time · **coordination-repo HEAD:** `79bb207` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-09-16T07:30:32.736471-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1144/1321 = 86.6% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 577/582 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 567/739 = 77% | `stop_coverage_audit.py` |
| Median placement latency | 260s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1199, 'eod_flatten': 71}) | `stop_coverage_audit.py exit-mechanism tally` |
