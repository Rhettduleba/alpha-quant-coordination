...
> **Generated:** 2026-08-18 16:51:02 Eastern Daylight Time · **coordination-repo HEAD:** `8e51424` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-08-18T07:30:32.922139-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 798/973 = 82.0% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 411/415 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 387/558 = 69% | `stop_coverage_audit.py` |
| Median placement latency | 259s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 50, 'candle/chandelier': 854, 'eod_flatten': 69}) | `stop_coverage_audit.py exit-mechanism tally` |
