...
> **Generated:** 2026-09-20 16:50:49 Eastern Daylight Time · **coordination-repo HEAD:** `8827f01` · by `strategy-research/system_facts.py` (read-only).
...
| consecutive_clean streak | 3 | `validation/clean_day_certifier.py:consecutive_clean()` |
...
| Universe generated_at | 2026-09-18T07:30:31.464092-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 1159/1336 = 86.8% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 581/586 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 578/750 = 77% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 51, 'candle/chandelier': 1214, 'eod_flatten': 71}) | `stop_coverage_audit.py exit-mechanism tally` |
