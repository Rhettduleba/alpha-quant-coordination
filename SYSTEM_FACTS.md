...
> **Generated:** 2026-07-31 16:50:47 Eastern Daylight Time · **coordination-repo HEAD:** `caa9407` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-31T07:30:31.010866-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 583/758 = 76.9% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 315/319 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 268/439 = 61% | `stop_coverage_audit.py` |
| Median placement latency | 257s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 646, 'eod_flatten': 65}) | `stop_coverage_audit.py exit-mechanism tally` |
