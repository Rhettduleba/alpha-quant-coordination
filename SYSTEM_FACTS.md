...
> **Generated:** 2026-07-09 16:50:32 Eastern Daylight Time · **coordination-repo HEAD:** `9c6477f` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-09T07:30:28.843289-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 298/473 = 63.0% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 175/179 = 98% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 123/294 = 42% | `stop_coverage_audit.py` |
| Median placement latency | 306s (~5.1 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 36, 'candle/chandelier': 374, 'eod_flatten': 63}) | `stop_coverage_audit.py exit-mechanism tally` |
