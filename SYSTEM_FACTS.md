...
> **Generated:** 2026-08-05 16:50:58 Eastern Daylight Time · **coordination-repo HEAD:** `390933b` · by `strategy-research/system_facts.py` (read-only).
...
| Fact | Live value | Source |
|---|---|---|
| Universe size today (published) | 144 | `ai-trading-strategy-agent/outputs/advisor_guidance/advisor_universe_latest.json:universe_size` |
| Universe generated_at | 2026-08-05T07:30:33.798374-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 627/802 = 78.2% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 332/336 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 295/466 = 63% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 49, 'candle/chandelier': 686, 'eod_flatten': 67}) | `stop_coverage_audit.py exit-mechanism tally` |
