...
> **Generated:** 2026-07-25 16:50:49 Eastern Daylight Time · **coordination-repo HEAD:** `2570a25` · by `strategy-research/system_facts.py` (read-only).
...
| Universe generated_at | 2026-07-24T07:30:35.081445-04:00 | `advisor_universe_latest.json:generated_at` |
...
| Entries with a broker resting stop | 515/690 = 74.6% | `strategy-research/stop_coverage_audit.py (re-derived from broker_orders_unified.csv)` |
| 9:35 cohort coverage | 283/287 = 99% | `stop_coverage_audit.py` |
| Re-arm/late cohort coverage | 232/403 = 58% | `stop_coverage_audit.py` |
| Median placement latency | 258s (~4.3 min) | `stop_coverage_audit.py` |
| PRIMARY protection mechanism | software poll (exit_bot_v2 + chandelier)  (mechanisms: {'resting_stop_HIT': 47, 'candle/chandelier': 579, 'eod_flatten': 64}) | `stop_coverage_audit.py exit-mechanism tally` |
